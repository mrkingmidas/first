...
class AmazonJp(Amazon):
	...
	override protected def GetUrl(artist as string, album as string) as string:
		return "http://www.amazon.${Suffix}/gp/search?search-alias=popular&__mk_ja_JP=%83J%83%5E%83J%83i&field-artist=${EncodeUrl(artist, PageEncoding)}&field-title=${EncodeUrl(album, PageEncoding)}&sort=relevancerank"
